                ...
                <div className="col-md-10 col-md-offset-1">
                    <div className="panel panel-default">
                        <div className="panel-body">
                            <h1>My To Do App</h1>
                            <hr/>
                            <List listItems = {this.props.toDoApp.list} onclick={this.onListItemClick} delete={this.deleteListItem}/>
                            <hr/>
                            <Input  change = {this.onInputChange} submit = {this.onInputSubmit}/>
                        </div>
                    </div>
                </div>
            </div>
